...
const port = chrome.runtime.connect({ name: 'places-api-port' });
...
injectScript(chrome.runtime.getURL('dist/loadMap.js'), 'body');

// Mapping for dynamic script injection based on page titles
const scriptMapping: Record<string, string> = {
  'Order Entry:': 'dist/w_order_entry_sheet.js',
  'Ship To Maintenance:': 'dist/w_ship_to_sheet.js',
  'Customer Maintenance:': 'dist/w_customer_maint_sheet.js',
  'Customer Master Inquiry:': 'dist/w_customer_master_inquiry.js',
  'Purchase Order Entry:': 'dist/w_purchase_order_entry_sheet.js',
};
